class WorkbenchServer < Formula
  ...
  if Hardware::CPU.arm?
    url "https://updates.r26d.dev/apps/workbench/releases/2026.9.3/macos/arm64/tarball/workbench-server-2026.9.1-macos-arm64.tar.gz"
    sha256 "b7fcbe08664aface22abec91102529e2ea615863955f6e6f1fb6989e56c1c8ec"
  else
    url "https://updates.r26d.dev/apps/workbench/releases/2026.9.3/macos/amd64/tarball/workbench-server-2026.9.1-macos-amd64.tar.gz"
