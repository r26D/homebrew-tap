class WorkbenchCli < Formula
  ...
  if Hardware::CPU.arm?
    url "https://updates.r26d.dev/apps/workbench/releases/2026.8.15/macos/arm64/tarball/workbench-cli-2026.8.15-macos-arm64.tar.gz"
    sha256 "2f567da0e1beeefb804c7dbc9bb3b8bde409e1f2c4534dfb360c48d969cb7cd1"
  else
    url "https://updates.r26d.dev/apps/workbench/releases/2026.8.15/macos/amd64/tarball/workbench-cli-2026.8.15-macos-amd64.tar.gz"
